...
```bash
python binary_test.py activitynet1.3 validation /data1/matheguo/important/result/activitynet/ori_ssn/model_best.pth.tar  /data1/matheguo/important/result/activitynet/ori_ssn/val_actionness.pkl --n_layers 6 --pos_enc 0
```
