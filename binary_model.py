...
class BinaryClassifier(torch.nn.Module):
    def __init__(self, num_class, course_segment, args, dropout=0.8, test_mode=False):
        ...
        self.rela_pos = nn.Sequential(nn.Linear(4*args.d_model, args.d_model), nn.SELU())
    ...
    def forward(self, feature, pos_ind, target=None, gts=None, feature_mask=None, test_mode=False):
        ...
        rois_pos_emb = self.rela_pos(pos_embedding(rois_relative_pos, self.d_model))
        ...
        return rois[:, :, 1:], actness, roi_scores.mean(2)