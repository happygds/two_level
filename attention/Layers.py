...
class MultiHeadAttention(nn.Module):
    ...
    def __init__(self, n_head, d_model, d_k, d_v, dropout=0.1, kernel_type='self_attn'):
        ...
        self.attention = ScaledDotProductAttention(d_model, d_k, attn_dropout=dropout, kernel_type=kernel_type)
    ...
    def forward(self, q, k, v, attn_mask=None):
        ...
        # perform attention, result size = (n_head * mb_size) x len_v x d_v
