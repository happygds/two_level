...
if __name__ == '__main__':
    ...
    for model_id in range(1, args.num_ensemble+1, 1):
        ...
        del ctx, workers, out_stage1, index_queue, result_queue
    ...
    for model_id in range(1, args.num_ensemble+1, 1):
        ...
        del ctx, workers, index_queue, result_queue
    ...
    for key in out_stage1.keys():
        ...
        ori_bboxes = list(filter(lambda b: b[1] - b[0] > 0, ori_bboxes))
        # merge proposals
        bboxes += ori_bboxes
    ...
    for model_id in range(1, args.num_ensemble+1, 1):
        ...
        del ctx, workers, out_stage2, index_queue, result_queue
